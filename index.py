...
app.layout = html.Div([
    ...
    children =[
        ...
        children=[dbc.Col(html.Img(src=app.get_asset_url("logo.jpg"), style={'width':'60%','margin-left': '15px'}),
                          lg=1),
                  dbc.Col(html.H1('HiGHmed Patient Dashboard', style={"font-size": "3rem", "margin-top": "30px",
                                                                   "vertical-align": "middle"}), lg=8),
                  dbc.Col(html.A(dcc.Link(html.H2('Tutorial', style={"font-size": "2rem", "margin-top": "20px",
...
def display_page(pathname):
    ...
    if pathname == "/apps/Workouts":
        ...
        tabs[3] = dcc.Link(
            dcc.Markdown("**&#9632 ECG analyze**"), href="/apps/ECG"
        )
