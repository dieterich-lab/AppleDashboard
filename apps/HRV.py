...
import modules.load_data_from_database_hrv as lddh
...
def update_ecg2(data,data_tab):
    if not data_tab:
        ...
        fig = update_ecg_figure(day, time, patient)
    return fig
